    ...
    <div class="row">
      <div class="col-md-12 col-sm-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            <form action="<?php echo base_url('empresas/actualizar').'/'.$empresa['idEmpresa']; ?>" method="post" autocomplete="off">
                  ...
                  <div class="col-md-4 col-sm-4">
                    ...
                    <select class="js-example-basic-single form-control" tabindex="-1" name="idTipoId" style="width: 100%;">
                      ...
                      <?php foreach ($tipoId as $id) : ?>
                        <option value="<?= $id['idTipoId'] ?>"<?php if($id['idTipoId']==$empresa['idTipoId']){echo 'selected';} ?>><?= $id['tipoId_nombre']?></option>
                      <?php endforeach; ?>
                    </select>
                  </div>
                  <div class="col-md-4 col-sm-4">
                    <label>N°. Identificación</label>
                    <input type="text" class="form-control" id="numeroId" name="numeroId" value="<?= $empresa['numeroId'] ?>" />
                  </div>
                </div>
              </div>
              <div class="form-group">
                  ...
                  <div class="col-4 col-sm-4">
                    ...
                    <select class="js-example-basic-single form-control" tabindex="-1" style="width: 100%;" name="pais" id="pais">
                      ...
                      <?php foreach($paises as $pais): ?>
                        <option value="<?= $pais['idPais'] ?>"<?php if($pais['idPais']==$empresa['idPais']){echo 'selected';} ?>><?= $pais['nombrePais'] ?></option>
                      <?php endforeach; ?>
                    </select>
                  </div>
                  <div class="col-4 col-sm-4">
