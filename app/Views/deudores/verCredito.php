              ...
              <div class="tab-pane fade show active" id="detalle" role="tabpanel" aria-labelledby="home-tab">
                ...
                <form action="<?php echo base_url('/creditos/actualizar'); ?>" class="mt-4" method="post" autocomplete="off">
                  <div class="col-md-6 col-sm-6 d-flex form-group">
                    ...
                    <input class="form-control w-100" readonly="readonly" id="numeroCredito" value="<?= $credito['idcreditos'] ?>" />
                  </div>
                  <div class="col-md-6 col-sm-6 d-flex form-group">
                    <div class="input-group-prepend">
                  ...
                  <div class="col-md-4 col-sm-6 d-flex form-group">
                    ...
                    <input class="form-control w-100" type="number" step="0.01" readonly="readonly" id="tasa" name="tasa" value="<?= $credito['tasa'] ?>" />
                  </div>
                  <div class="col-md-4 col-sm-6 d-flex form-group">
                    <div class="input-group-prepend" style="height: fit-content;">
                      <label class="input-group-text text-label rounded-0">Valor del Crédito</label>
                    </div>
                    <input class="form-control w-100" readonly="readonly" id="cupo" name="cupo" value="<?= '$ '.number_format($credito['cupo'],0)  ?>" />
                    <div id="cupo"></div>
                  </div>
                  <div class="col-md-4 col-sm-6 d-flex form-group frecuencia">
                    ...
                    <p class="form-control d-flex align-items-center w-100 text-label mb-0">
                      <small class="d-flex justify-content-around w-100">
                        ...
                        <?php if($credito['frecuencia']=='M'){echo 'checked';} ?>
                        disabled /> Quincenal: <input type="radio" class="flat" name="frecuencia" id="quincenal" value="Q"
                        <?php if($credito['frecuencia']=='Q'){echo 'checked';} ?>
                        disabled />
                      </small>
                    </p>
                  </div>
                  <div class="col-md-4 col-sm-6 d-flex form-group">
                    ...
                    <input class="form-control w-100" readonly="readonly" id="cuotas" name="cuotas" value="<?= $credito['cuotas'] ?>" />
                    <div id="cuotas"></div>
                  </div>
                  <div class="col-md-4 col-sm-6 d-flex form-group">
                    <div class="input-group-prepend">
                  ...
                  <div class="col-md-12 col-sm-12 d-flex justify-content-center form-group">
                    <a href="<?php echo base_url('/creditos/misCreditos'); ?>" class="btn btn-success">Regresar</a>
                  </div>
                </form>
                <!-- /Nuevo Crédito -->
                <div class="clearfix"></div>
